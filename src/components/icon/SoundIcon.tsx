...
export default function SoundIcon({ className }: Props) {
  return (
    <svg
      width='800px'
      height='800px'
      ...
      className={className}
    >
      <path d='M18.36,19.36a1,1,0,0,1-.7-.29,1,1,0,0,1,0-1.41,8,8,0,0,0,0-11.32,1,1,0,0,1,1.41-1.41,10,10,0,0,1,0,14.14A1,1,0,0,1,18.36,19.36Z'></path>
