...
export default function ModalVideoPlayer({ post }: Props) {
  const { videoUrl, authorName, authorUsername, caption } = post;
  ...
  return (
    <div
      ...
      className='group relative flex h-full w-full cursor-pointer items-center overflow-hidden xs:min-w-[512px]'
    >
